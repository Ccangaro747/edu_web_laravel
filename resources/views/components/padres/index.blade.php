...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h2 class="titulos">Padre de: {{$hijo->alumno}} - <small>({{$hijo->curso}})</small></h2>
        </div>
    </div>    
</div>    
...
<div class="container-fluid">
    <div class="row py-2 d-flex align-items-stretch">
        ...
        <div class="col-lg-3 col-6 d-flex my-2">
            <a href="{{ url('notificacionespadrestipo', ['tipo' => $not->id]) }}" class="col box-componentes" style="background-color: #{{ $not->color }};">
